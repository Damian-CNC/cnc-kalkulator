...
export const PREFERENCES_KEY = 'cnc_preferences_configured';

export const readPreferencesConfigured = (): boolean => {
  try {
...
/** Step 1 of onboarding: interface language + unit system. */
const InitialPreferencesModal = ({ onDone }: { onDone: () => void }) => {
      ...
      <div className="w-full max-w-md rounded-3xl border border-zinc-800 bg-zinc-900/90 backdrop-blur-xl shadow-2xl p-5 sm:p-6 max-h-[90vh] overflow-y-auto">
        ...
        <div className="grid grid-cols-2 gap-2 mb-6">
          {supportedLanguages.map((l) => (
            ...
            >
              <span className="text-xs font-black tracking-widest text-zinc-500">{l.label}</span>
